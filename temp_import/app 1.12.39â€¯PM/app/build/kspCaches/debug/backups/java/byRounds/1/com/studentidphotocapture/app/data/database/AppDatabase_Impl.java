  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `user` (`id` TEXT NOT NULL, `username` TEXT NOT NULL, `password` TEXT NOT NULL, `role` TEXT NOT NULL, `schoolCode` TEXT, PRIMARY KEY(`id`))");
        db.execSQL("CREATE TABLE IF NOT EXISTS `student` (`id` TEXT NOT NULL, `name` TEXT NOT NULL, `rollNumber` TEXT NOT NULL, `classGrade` TEXT NOT NULL, `section` TEXT NOT NULL, `schoolCode` TEXT NOT NULL, `photoStatus` TEXT NOT NULL, `photoUrl` TEXT, `photoCapturedAt` INTEGER, PRIMARY KEY(`id`))");
        ...
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'fa3a26a3bcb1f1015d7088583c0fb1d1')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        final HashMap<String, TableInfo.Column> _columnsStudent = new HashMap<String, TableInfo.Column>(9);
    ...
    }, "fa3a26a3bcb1f1015d7088583c0fb1d1", "2d5b0649161f29c7e4eef501eb8e32b7");
