...
public final class UserDao_Impl implements UserDao {
  ...
  public UserDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfUser = new EntityInsertionAdapter<User>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `user` (`id`,`username`,`password`,`role`,`schoolCode`,`phoneNumber`,`assignedClass`,`assignedSection`) VALUES (?,?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        if (entity.getAssignedClass() == null) {
          statement.bindNull(7);
        } else {
          statement.bindString(7, entity.getAssignedClass());
        }
        if (entity.getAssignedSection() == null) {
          statement.bindNull(8);
        } else {
          statement.bindString(8, entity.getAssignedSection());
        }
      }
    };
  }
    ...
    return CoroutinesRoom.execute(__db, false, _cancellationSignal, new Callable<User>() {
      ...
      public User call() throws Exception {
        ...
        try {
          ...
          final int _cursorIndexOfAssignedClass = CursorUtil.getColumnIndexOrThrow(_cursor, "assignedClass");
          final int _cursorIndexOfAssignedSection = CursorUtil.getColumnIndexOrThrow(_cursor, "assignedSection");
          final User _result;
          if (_cursor.moveToFirst()) {
            ...
            final String _tmpAssignedClass;
            if (_cursor.isNull(_cursorIndexOfAssignedClass)) {
              _tmpAssignedClass = null;
            } else {
              _tmpAssignedClass = _cursor.getString(_cursorIndexOfAssignedClass);
            }
            final String _tmpAssignedSection;
            if (_cursor.isNull(_cursorIndexOfAssignedSection)) {
              _tmpAssignedSection = null;
            } else {
              _tmpAssignedSection = _cursor.getString(_cursorIndexOfAssignedSection);
            }
            _result = new User(_tmpId,_tmpUsername,_tmpPassword,_tmpRole,_tmpSchoolCode,_tmpPhoneNumber,_tmpAssignedClass,_tmpAssignedSection);
          } else {
            _result = null;
          }
          return _result;
  ...
  @Override
  public Object getUserByMobile(final String mobile, final Continuation<? super User> $completion) {
    final String _sql = "SELECT * FROM user WHERE phoneNumber = ? LIMIT 1";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
      ...
      public List<User> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new User(_tmpId,_tmpUsername,_tmpPassword,_tmpRole,_tmpSchoolCode,_tmpPhoneNumber,_tmpAssignedClass,_tmpAssignedSection);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  private String __UserRole_enumToString(@NonNull final UserRole _value) {
    switch (_value) {
      ...
      case ULTRA_SUPER_ADMIN: return "ULTRA_SUPER_ADMIN";
  ...
  private UserRole __UserRole_stringToEnum(@NonNull final String _value) {
    switch (_value) {
      ...
      case "ULTRA_SUPER_ADMIN": return UserRole.ULTRA_SUPER_ADMIN;
